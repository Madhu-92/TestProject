...
def paying_debt_off_in_a_year(var_balance, var_annualinterest, var_monthlypayment):
    """
    This takes balance, annual interest rate, monthly payment rate
    """
    for var_pb in range(12):
        var_pb = var_balance
        var_mir = (var_annualinterest)/12.0
        var_mmp = var_monthlypayment*var_pb
        var_mub = var_pb - var_mmp
